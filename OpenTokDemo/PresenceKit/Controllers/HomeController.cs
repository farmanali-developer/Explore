...
namespace PresenceKit.Controllers
{
    public class HomeController : Controller
    {
        ...
        const string SessionId = "2_MX40NjY2NjczMn5-MTU4NjY5NzQ2MDM1NX4wUmJ1WjZuOG5aZmF1Z3JoWVFMWnFxZW9-UH4";
        ...
        public ActionResult Users()
        {
            ...
            string token = Settings.Tk.GenerateToken(SessionId, Role.PUBLISHER, data:JsonConvert.SerializeObject((new { name})));
